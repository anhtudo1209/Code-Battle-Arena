        ...
        {!isCompleted && (
          <div className={`footer-container ${footerClassName}`}>
            <div className={`footer-nav ${currentStep !== 1 ? 'spread' : 'end'}`}>
              ...
              {!isLastStep && (
                <button onClick={handleNext} className="next-button" {...nextButtonProps}>
                  {nextButtonText}
                </button>
              )}
            </div>
    ...
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: '#06b6d4', color: '#06b6d4' },
          complete: { scale: 1, backgroundColor: '#06b6d4', color: '#3b82f6' }
        }}
