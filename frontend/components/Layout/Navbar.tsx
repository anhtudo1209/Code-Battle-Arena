      ...
      <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 border-r border-ui-border pr-4 mr-2">
               <div className="text-right hidden sm:block">
                    <div className="text-xs font-bold text-ui-text-main uppercase">Drifter</div>
                    <div className="text-[10px] font-mono text-brand font-bold tracking-wider">ELO: 470</div>
               </div>
               
               {/* Updated Avatar to Match Settings Style */}
               <div 
                    className="w-8 h-8 flex items-center justify-center overflow-hidden relative border border-white/20 shadow-glow"
                    style={{ backgroundColor: '#14b8a6' }} // Custom Teal color
               >
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/20 pointer-events-none"></div>
                    <img 
                        src="https://api.dicebear.com/9.x/bottts/svg?seed=robot" 
                        alt="User" 
